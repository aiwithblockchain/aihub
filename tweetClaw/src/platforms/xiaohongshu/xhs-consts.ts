export const XHS_API_ENDPOINTS = {
  ...
  SEARCH_USERSEARCH: '/api/sns/web/v1/search/usersearch',
...
export const XHS_MSG_TYPE = {
  ...
  FETCH_NOTE_DETAIL_STATS: 'XHS_FETCH_NOTE_DETAIL_STATS',
  POST_COMMENT: 'XHS_POST_COMMENT',
  SEARCH_USERS: 'XHS_SEARCH_USERS',
  SEARCH_USERSEARCH: 'XHS_SEARCH_USERSEARCH',
  ...
  CREATE_COLLECTION: 'XHS_CREATE_COLLECTION',
  LIST_COLLECTIONS: 'XHS_LIST_COLLECTIONS',
  LIST_COLLECTION_NOTES: 'XHS_LIST_COLLECTION_NOTES',
  UPDATE_COLLECTION: 'XHS_UPDATE_COLLECTION',
} as const;
