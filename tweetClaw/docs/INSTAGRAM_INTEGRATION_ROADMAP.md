...
|--------|------------|------|------|
| P0 | `command.ig_get_self_info` | 获取自己账号信息 | 待开发 |
| P0 | `command.ig_get_feed` | 获取主页 Feed | 待开发 |
| P1 | `command.ig_get_user_info` | 获取他人用户信息 | 待开发 |
...
| P0 | `command.ig_like_media` | 点赞 | 待开发 |
| P0 | `command.ig_post_comment` | 发布评论 | 待开发 |
| P0 | `command.ig_follow_user` | 关注用户 | 待开发 |
| P1 | `command.ig_upload_media` | 上传媒体文件 | 待开发 |
| P1 | `command.ig_unlike_media` | 取消点赞 | 待开发 |
| P1 | `command.ig_unfollow_user` | 取消关注 | 待开发 |
