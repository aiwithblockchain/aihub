...
| 优先级 | API | messageType | 预计工时 | 实际状态 | 测试日期 |
|--------|-----|------------|---------|---------|---------|
| P0 | 获取自己账号信息 | `ig_get_self_info` | 0.5 天 | ✅ 已完成 | 2026-06-07 |
| P0 | 获取主页 Feed | `ig_get_feed` | 1 天 | ✅ 已完成 | 2026-06-07 |
| P1 | 获取用户信息 | `ig_get_user_info` | 0.5 天 | ✅ 已完成 | 2026-06-07 |
| P1 | 获取媒体详情 | `ig_get_media` | 0.5 天 | ✅ 已完成 | 2026-06-07 |
| P1 | 搜索用户 | `ig_search_user` | 0.5 天 | ✅ 已完成 | 2026-06-07 |
| P1 | 获取评论列表 | `ig_get_media_comments` | 0.5 天 | 待开发 | - |
| P1 | 搜索内容 | `ig_search` | 1 天 | 待开发 | - |
| P2 | 获取用户媒体列表 | `ig_get_user_media` | 0.5 天 | 待开发 | - |
| P2 | 获取粉丝/关注列表 | `ig_get_followers/following` | 1 天 | 待开发 | - |

**里程碑：** 完成 `ig-main-entrance.ts` 基础框架 + 8 个读取 API

**实际进度：** 已完成 5/9 个读取 API (55%) - ✅ 测试通过 5/5 (100%)
...
| 优先级 | API | messageType | 预计工时 | 实际状态 | 测试日期 |
|--------|-----|------------|---------|---------|---------|
| P0 | 点赞 | `ig_like_media` | 0.5 天 | ✅ 已完成 | 2026-06-06 |
| P0 | 发布评论 | `ig_post_comment` | 0.5 天 | ✅ 已完成 | 2026-06-07 |
| P0 | 关注用户 | `ig_follow_user` | 0.5 天 | ✅ 已完成 | 2026-06-07 |
| P0 | 发布媒体 | `ig_post_media` | 2 天 | 待开发 | - |
| P1 | 上传媒体 | `ig_upload_media` | 1.5 天 | 待开发 | - |
| P1 | 取消点赞 | `ig_unlike_media` | 0.5 天 | ✅ 已完成 | 2026-06-07 |
| P1 | 取消关注 | `ig_unfollow_user` | 0.5 天 | ✅ 已完成 | 2026-06-07 |
| P2 | 删除媒体 | `ig_delete_media` | 0.5 天 | 待开发 | - |
| P2 | 删除评论 | `ig_delete_comment` | 0.5 天 | 待开发 | - |

**里程碑：** 完成核心写操作 + 媒体上传流程

**实际进度：** 已完成 6/9 个写操作 API (67%)
