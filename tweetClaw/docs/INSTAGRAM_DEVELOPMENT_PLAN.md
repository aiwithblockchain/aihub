...
| 优先级 | API | messageType | 预计工时 | 实际状态 |
|--------|-----|------------|---------|---------|
| P0 | 获取自己账号信息 | `ig_get_self_info` | 0.5 天 | ✅ 已完成 |
| P0 | 获取主页 Feed | `ig_get_feed` | 1 天 | ✅ 已完成 (2026-06-07) |
| P1 | 获取用户信息 | `ig_get_user_info` | 0.5 天 | ✅ 已完成 |
| P1 | 获取媒体详情 | `ig_get_media` | 0.5 天 | ✅ 已完成 (2026-06-07) |
| P1 | 搜索用户 | `ig_search_user` | 0.5 天 | ✅ 已完成 |
