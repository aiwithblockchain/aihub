...
```bash
python3 .Codex/skills/ui-ux-pro-max/scripts/search.py "[product description]" --design-system -p "[Project Name]"
```
...
```bash
python3 .Codex/skills/ui-ux-pro-max/scripts/search.py "[product description]" --design-system --persist -p "[Project Name]"
```
...
python3 .Codex/skills/ui-ux-pro-max/scripts/search.py "[description]" --design-system -p "[Project]"

# Persist design system
python3 .Codex/skills/ui-ux-pro-max/scripts/search.py "[description]" --design-system --persist -p "[Project]"

# Domain-specific search
python3 .Codex/skills/ui-ux-pro-max/scripts/search.py "[query]" --domain [style|typography|chart]

# Stack-specific guidelines
python3 .Codex/skills/ui-ux-pro-max/scripts/search.py "[query]" --stack [react|html-tailwind|vue]
```
