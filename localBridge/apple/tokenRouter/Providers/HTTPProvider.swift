...
final class HTTPProvider: AIProviderProtocol, Sendable {
    ...
    init(displayName: String, baseURL: URL, apiKeyKeychainKey: String, model: String, keychain: KeychainTokenStore = KeychainTokenStore(), sseClient: SSEClient = SSEClient()) {
