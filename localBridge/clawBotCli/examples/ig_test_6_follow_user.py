#!/usr/bin/env python3
"""Test IG API 6: follow_user (关注用户)

Usage:
  python3 examples/ig_test_6_follow_user.py [user_id]
...
# 需要提供 user_id
if len(sys.argv) < 2:
    print("Usage: python3 examples/ig_test_6_follow_user.py <user_id>")
    print("Example: python3 examples/ig_test_6_follow_user.py 123456789")
    sys.exit(1)

user_id = sys.argv[1]

print("=" * 60)
print(f"Test: ig_follow_user (关注用户)")
print(f"User ID: {user_id}")
print("=" * 60)
print("⚠️  WARNING: This is a WRITE operation. Press Ctrl+C to cancel.")
print()

result = client.ig.follow_user(user_id=user_id)
