#!/usr/bin/env python3
"""
Test script for GET /api/v1/x/following

Usage:
    python tests/test_following.py --userId 44196397
    python tests/test_following.py --userId 44196397 --count 5
    python tests/test_following.py --userId 44196397 --count 5 --cursor <cursor_string>
"""
import sys
import os
import json
...
def test_following(user_id: str, count: int = 20, cursor: str = None):
    print("\n" + "=" * 60)
    print("Testing: GET /api/v1/x/following")
    print("=" * 60)
    ...
    try:
        resp = requests.get(f"{BASE_URL}/api/v1/x/following", params=params, timeout=TIMEOUT)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Test GET /api/v1/x/following")
    ...
    ok = test_following(args.userId, args.count, args.cursor)
